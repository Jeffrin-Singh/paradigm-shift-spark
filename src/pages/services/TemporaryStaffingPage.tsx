...
const TemporaryStaffingPage = () => (
  <Layout>
    <PageHero title="Temporary Staffing" subtitle="Our Services" description="We help you with your staffing requirements so that you can focus on your core business!" />

...
const TemporaryStaffingPage = () => (
  <Layout>
    <PageHero title="Temporary Staffing" subtitle="Clients" description="We help you with your staffing requirements so that you can focus on your core business!" image={serviceImage} />
